...
/******/ 	__webpack_require__.p = "./dist/webpack/js";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _guildZoneIndex = __webpack_require__(6);
	
	var _guildZoneIndex2 = _interopRequireDefault(_guildZoneIndex);
	
	var _guildZoneRules = __webpack_require__(66);
	
	var _guildZoneRules2 = _interopRequireDefault(_guildZoneRules);
	...
	$$(document).on('pageInit', function (e) {
		...
		var value = _store.myStore._f7Ajax('get', { 'uid': _store.myStore.paramter.get('uid'), 'token': _store.myStore.paramter.get('token'), 'act_id': 1 }, _store.myStore.project.url, 'info_data');
	
		if (page.name === 'guild-zone-index') {
	
			var guildListPage = new _vue2.default(_guildZoneIndex2.default);
			guildListPage.$mount('#guild-zone-index .page-content');
			console.log('guild-zone-index-page');
		}
	
		if (page.name === 'guild-zone-rules') {
			var guildZonerules = new _vue2.default(_guildZoneRules2.default);
	...
	/*初始化*/
	var pageName = _store.myStore.watchHash.get();
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] src\\views\\guild-zone-index.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "D:\\part\\project\\activity_list\\guild_support_lachine\\src\\views\\guild-zone-index.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bannerSuccess = __webpack_require__(10);
	
	var _bannerSuccess2 = _interopRequireDefault(_bannerSuccess);
	
	var _bannerInner = __webpack_require__(61);
	
	var _bannerInner2 = _interopRequireDefault(_bannerInner);
	...
	exports.default = {
	  ...
	  ready: function ready() {
	    /* 取uid */
	    var vue_this = this;
	    vue_this.info_data = _store.myStore.storage.get('info_data');
	    console.log(vue_this.info_data);
	  },
	
	  components: {
	    banner_success: _bannerSuccess2.default,
	    banner_inner: _bannerInner2.default
	  },
	
	  watch: {
	    info_data: function info_data(val) {
	      var vue_this = this;
	      if (!vue_this.info_data) {
	        var cb = function cb() {
	          var info_data = _store.myStore.storage.get('info_data');
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\components\\banner-success.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\part\\project\\activity_list\\guild_support_lachine\\src\\components\\banner-success.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  ready: function ready() {
	    var vue_this = this;
	    vue_this.info_data = _store.myStore.storage.get('info_data') || this.info_data;
	  ...
	  computed: {
	    buildTime: function buildTime() {
	      if (this.item) {
	        var buildtime = this.create_time;
	        var buildtimeIn = new Date(parseInt(buildtime) * 1000).toLocaleString();
	        var length = buildtimeIn.indexOf(' ');
	        var buildtimeTn = new Date(parseInt(buildtime) * 1000).toLocaleString().substr(0, length).split('/').join('-');
	        console.log(buildtimeTn);
	        return buildtimeTn;
	      }
	    },
	    buildKind: function buildKind() {
	      if (this.item) {
	        var buildcreat = this.create_time;
	        //春节时间
	        var buildholiday = new Date(2016, 1, 7).getTime() / 1000;
	    ...
	    gsuc_joins: function gsuc_joins() {
	      return "dist/img/gsuc_joins.png";
	    }
	  },
	  methods: {
	    inlinkNext: function inlinkNext() {
	      if (isInApp.call()) {
	        var path = "http://app.52tt.com";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var myStore = exports.myStore = {
		// http://192.168.9.230:8089
		// "http://api.52tt.com"
		project: {
			url: "http://api.52tt.com/act/guild_popularity", //配置接口路径
			joinUrl: "http://api.52tt.com/act/guild_popularity_signup" },
		//配置报名接口路径
		_f7Ajax: function _f7Ajax(method, parameter, url, locatl, cb) {
		...
		storage: {
			...
			set: function set(key, value) {
				var serializable = $$.isArray(value),
				    storeValue = serializable ? value : (0, _stringify2.default)(value);
		...
		paramter: {
			get: function get(key) {
				if ((typeof key === "undefined" ? "undefined" : (0, _typeof3.default)(key)) !== undefined || key !== "undefined" || key) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(38)('iterator');
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\components\\banner-inner.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\part\\project\\activity_list\\guild_support_lachine\\src\\components\\banner-inner.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  ready: function ready() {
	    var vue_this = this;
	    if (_store.myStore.storage.get('info_data') || this.info_data) {
	      vue_this.info_data = _store.myStore.storage.get('info_data') || this.info_data;
	      vue_this.user_ID = vue_this.info_data.user_ID;
	      myApp.hideIndicator();
	    }
	  },
	  ...
	  computed: {
	    img_url: function img_url() {
	      return "dist/img/ginner.png";
	    }
	  },
	  methods: {
	    linkNext: function linkNext() {
	      if (isInApp.call()) {
	        var path = "http://app.52tt.com";
	        // const path = "http://192.168.9.230";
	        var link = path + "/active/guild_support_lachine/#!/#guild-zone-rules";
	        myWebview.appNav(link);
	      }
	    }
	  },
	...
	/* generated by vue-loader */
	// <template>
	//   <div class="counter" @click="linkNext() | debounce 500">
	//     <img v-bind:src="img_url" alt="" class="entrance">
	//     <a href="javascript:void(0)" class="now-part"></a>
	//   </div>
	// </template>
	//
	// <script>
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"page-banner\"><div v-if=\"is_signup == 1\"><banner_success></banner_success></div><div v-else=\"v-else\"><banner_inner></banner_inner></div></div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\views\\guild-zone-rules.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\part\\project\\activity_list\\guild_support_lachine\\src\\views\\guild-zone-rules.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bannerRules = __webpack_require__(68);
	
	var _bannerRules2 = _interopRequireDefault(_bannerRules);
	...
	exports.default = {
	  ...
	  components: {
	    banner_rules: _bannerRules2.default
	  }
	};
	// </script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\components\\banner-rules.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\part\\project\\activity_list\\guild_support_lachine\\src\\components\\banner-rules.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    joinUs: function joinUs(key, value) {
	      var vue_this = this;
	      if (key) {
	        ...
	        var promise = new _promise2.default(function (resolve, reject) {
	          var value = _store.myStore._f7Ajax('get', { 'uid': _store.myStore.paramter.get('uid'), 'token': _store.myStore.paramter.get('token'), 'act_id': 1 }, _store.myStore.project.joinUrl, 'info_data');
	          resolve(value);
	        });
	  ...
	  component: {},
	  computed: {
	    grule_02: function grule_02() {
	      return "dist/img/grule_02.png";
	    },
	    grule_03: function grule_03() {
	      return "dist/img/grule_03.png";
	    },
	    grule_04: function grule_04() {
	      return "dist/img/grule_04.png";
	    },
	    grule_05: function grule_05() {
	      return "dist/img/grule_05.png";
	    },
	    grule_06: function grule_06() {
	      return "dist/img/grule_06.png";
	    },
	    grule_07: function grule_07() {
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"container rule\"><banner_rules></banner_rules></div>";
